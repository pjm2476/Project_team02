...
/* Short answer game */
public class SA_Game {
	
	SA_Question SA= new SA_Question();
	
	private ArrayList<String> question = new ArrayList<String>(SA.Question());
	private ArrayList<String> answer = new ArrayList<String>(SA.Answer());
